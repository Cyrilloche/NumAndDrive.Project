...
namespace NumAndDrive.Migrations
{
    ...
    [Migration("20240528085827_UpdateTravelTableAddBoolToReturnTravel")]
    partial class UpdateTravelTableAddBoolToReturnTravel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NumAndDrive.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "37ba0148-0c11-4208-86a1-cfc75f35ec4b",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEN0OH/LQz1warsv4q4mrvWiE5EqAsQaHpxYWlSMOuSaZFzVNUPsdLD6hRne5D/+hXA==",
            ...
            modelBuilder.Entity("NumAndDrive.Models.Travel", b =>
                {
                    b.HasOne("NumAndDrive.Models.Address", "ArrivalAddress")
                        .WithMany("ArrivalTravel")
                        .HasForeignKey("ArrivalAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NumAndDrive.Models.Address", "DepartureAddress")
