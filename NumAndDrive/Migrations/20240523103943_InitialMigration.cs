        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublisherUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewedUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReviewerUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TravelId = table.Column<int>(type: "int", nullable: false),
                    PassengerUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CurrentClassroomId", "CurrentDriverTypeId", "CurrentStatusId", "Email", "EmailConfirmed", "FirstConnection", "Firstname", "Lastname", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "1", 0, "2c96a26b-43c0-4dee-ae76-94ce4edd1df3", null, null, null, "admin@admin-numanddrive.fr", true, false, "", "", false, null, "ADMIN@ADMIN-NUMANDDRIVE.FR", "ADMIN@ADMIN-NUMANDDRIVE.FR", "AQAAAAIAAYagAAAAEDbV20xvlIli2oaYzODRf5lgqZY+Ed4vGA18Bwc579/psf0FRWxZQQSyXmLgwF8p+Q==", null, false, "", false, "admin@admin-numanddrive.fr" });
